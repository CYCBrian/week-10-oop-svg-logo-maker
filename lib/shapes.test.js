...
describe('Circle', () => {
  it('should render a circle SVG element with the specified shape color', () => {
    ...
    expect(svgCode).toEqual('<circle cx="150" cy="100" r="100" fill="blue"/>');
  });
});
...
describe('Square', () => {
  it('should render a square SVG element with the specified shape color', () => {
    ...
    expect(svgCode).toEqual('<rect x="50" y="0" width="200" height="200" fill="blue"/>');
  });
});
...
describe('Triangle', () => {
  it('should render a triangle SVG element with the specified shape color', () => {
    ...
    expect(svgCode).toEqual('<polygon points="150 0,300 135,0 135" fill="blue"/>');
  });
});
